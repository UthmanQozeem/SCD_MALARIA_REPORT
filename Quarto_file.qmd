---
title: "SCD_ANALYSIS_REPORT & MALARIA_PREVELANCE_NIGERIA"
...
colnames(import_data) <- trimws(colnames(import_data))
...
This data comes from '*a survey conducted to check the awareness and readiness to accept treatment of SCD*' 
